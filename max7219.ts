...
namespace max7219_matrix {
    ...
    */
    //% block="旋转点阵屏 $rotation|反转显示 $reversed" rotation.defl=rotation_direction.none group="1. Setup" blockExternalInputs=true advanced=true
    ...
    */
    //% block="滚动显示 $text|延迟 (ms) $delay|完成暂停 (ms) $endDelay" text.defl="Hello world!" delay.min=0 delay.defl=75 endDelay.min=0 endDelay.defl=500 group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="从左边开始显示 $text|偏移 $offset|显示前清除屏幕 $clear" text.defl="Hi!" offset.min=-8 clear.defl=true group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="从右边开始显示文本 $text|显示前清除屏幕 $clear" text.defl="Hi!" clear.defl=true group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="从数组显示自定义字符 $customCharArray|偏移 $offset|显示前清除屏幕 $clear" offset.min=-8 clear.defl=true group="2. Display text on matrixs" blockExternalInputs=true advanced=true
    ...
    */
    //% block="从数组生成一个自定义字符 $text" text.defl="B00100000,B01000000,B10000110,B10000000,B10000000,B10000110,B01000000,B00100000" group="2. Display text on matrixs" blockExternalInputs=true advanced=true
    ...
    */
    //% block="显示所有文本，显示间隔 $delay" delay.min=0 delay.defl=200 group="2. Display text on matrixs" advanced=true
    ...
    */
    //% block="设置所有点阵屏状态为 $status" status.defl=true group="3. Basic light control" advanced=true
    ...
    */
    //% block="设置所有点阵屏亮度 $level" level.min=0 level.max=15 level.defl=15 group="3. Basic light control"
    ...
    */
    //% block="设置亮度 $level 点阵屏编号 = $index" level.min=0 level.max=15 level.defl=15 index.min=0 group="3. Basic light control" advanced=true
    ...
    */
    //% block="点亮所有点阵屏" group="3. Basic light control"
    ...
    */
    //% block="点亮点阵屏，编号= $index" index.min=0 group="3. Basic light control" advanced=true
    ...
    */
    //% block="清楚所有点阵" group="3. Basic light control"
    ...
    */
    //% block="清除指定的点阵屏，编号= $index" index.min=0 group="3. Basic light control" advanced=true
    ...
    */
    //% block="随机点亮所有点阵屏" index.min=0 group="3. Basic light control"
